...
<div class="position-absolute top-0 start-0 p-5">
  <img class="h-100px blur-4" src="assets/images/elements/08.svg" alt="">
</div>
<!-- SVG icon decoration -->
<div class="position-absolute bottom-0 start-0 m-5 p-5">
  <img class="h-100px blur-7 m-5" src="assets/images/elements/06.svg" alt="">
</div>

<!-- Container START -->
<div class="container h-100 p-xl-0">
  <div class="row align-items-center h-100 g-4 g-xl-0 position-relative z-index-1 text-center text-lg-start">
    <div class="col-lg-5">
      <!-- Heading -->
      ...
      <div class="d-flex justify-content-center justify-content-lg-start mt-4">
        ...
        <a href="#"><img class="h-50px ms-1 ms-sm-2" src="assets/images/google-play.svg" alt="google-play"></a>
      </div>
    </div>
    <div class="col-lg-7 position-relative">
      <!-- SVG icon decoration -->
      <div class="position-absolute top-0 start-0 mt-5 z-index-1 d-none d-lg-block">
        <img class="h-100px" src="assets/images/elements/02.svg" alt="">
      </div>
      <!-- SVG icon decoration -->
      <div class="position-absolute top-0 end-0 d-none d-lg-block">
        <img class="h-100px" src="assets/images/elements/03.svg" alt="">
      </div>
      <!-- SVG icon decoration -->  
      <div class="position-absolute bottom-0 end-0 z-index-1 me-5 d-none d-lg-block">
        <img class="h-150px" src="assets/images/elements/04.svg" alt="">
      </div>
      <!-- SVG icon decoration -->    
      <div class="position-absolute top-50 start-0 translate-middle-y z-index-1 ms-5 ps-5 mt-5 d-none d-lg-block">
        <img class="h-100px" src="assets/images/elements/07.svg" alt="">
      </div>
      <!-- SVG icon decoration -->    
      <div class="position-absolute top-50 end-0 translate-middle-y z-index-1 d-none d-lg-block">
        <img class="h-50px blur-1 " src="assets/images/elements/06.svg" alt="">
      </div>
      <!-- SVG icon decoration -->  
      <div class="position-absolute bottom-0 start-0 ms-5 ps-5 d-none d-lg-block">
        <img class="h-100px blur-2" src="assets/images/elements/06.svg" alt="">
      </div>
      <!-- SVG icon decoration -->  
      <div class="position-absolute top-50 end-0 translate-middle-y z-index-1 me-4 mt-n5 d-none d-lg-block">
        <img class="h-150px mt-n5 me-5" src="assets/images/elements/05.svg" alt="">
      </div>
      <!-- iphone-x mockup START -->
      <div class="iphone-x" style="background: url(assets/images/mockup/app-placeholder.jpg); background-size: cover;">
        <i></i>
        <b></b>
      </div>
      <!-- iphone-x mockup END -->
...
<!-- QR-code START -->
<div class="position-absolute bottom-0 end-0 m-5 text-center d-none d-xl-block">
